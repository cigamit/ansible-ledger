...
while (!$done) {
    ...
    if (isset($s['id'])) {
        ...
        $html = $twig->render('report_email.html', array_merge($twigarr, array('report' => $report, 'data' => $data, 'filters' => $report->filters, 'columns' => $report->columns, 'sortc' => $report->sortc, 'sortd' => $report->sortd))); 
